...
def createRunTestSteps():
    ...
    testSteps.extend(common.remoteParseCtestLogAndStoreIt())
    testSteps.extend(common.remoteStoreCoredumps())
    testSteps.extend(common.writeBuildResultsToDatabase(alwaysRun=True))
